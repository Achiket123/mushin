...
class _HomePageState extends State<HomePage> {
  ...
  getLockedApps() async {
    ...
    packages.addAll(List<String>.from(box.values.toSet().toList()));
    packages.toSet().toList();
    debugPrint("Locked apps: $packages");
    final data = box.values.toSet();
    await box.clear();
                                  ...
                                  child: ListTile(
                                    ...
                                    >(
                                      builder: (context, state) {
                                        ...
                                        else if (state is lb.LockLoading) {
                                          return Center(
